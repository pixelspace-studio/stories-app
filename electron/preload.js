...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    resizeWidget: (width, height, direction) => ipcRenderer.invoke('resize-widget', width, height, direction),
    ...
    // Smart Transforms
    onOpenTransformDropdown: (callback) => ipcRenderer.on('open-transform-dropdown', callback),
    requestTransformApply: (data) => ipcRenderer.invoke('request-transform-apply', data),

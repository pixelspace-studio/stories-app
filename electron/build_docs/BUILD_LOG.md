...
| 0.9.10-10 | internal (signed) | Arturo | 2026-07-16 | feature/suffix-and-media-import | [`built/0.9.10-10`](../../../../tree/built/0.9.10-10) | — (local only) |

Note: `0.9.10-10` adds the two new features — transcript suffix (user-defined word/phrase appended to final transcriptions) and media file import (transcribe existing audio/video via ffmpeg 16 kHz mono normalization; requires system ffmpeg) — plus the suffix-editor UI fixes. Signed with the Pixelspace cert, not notarized.
